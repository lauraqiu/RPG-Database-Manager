...
CREATE TABLE Characters (
                            ...
                            strength INT(5) NOT NULL DEFAULT 1,
                            intelligence INT(5) NOT NULL DEFAULT 1,
                            charisma INT(5) NOT NULL DEFAULT 1,
                            dexterity INT(5) NOT NULL DEFAULT 1,
                            luck INT(5) NOT NULL DEFAULT 1,
...
CREATE TABLE Inventory {
    ...
    FOREIGN KEY (CID, AccName) REFERENCES Character(ID, AccName) ON DELETE CASCADE,
...
CREATE TABLE LocalLeaderboard {
    ...
    PRIMARY KEY (ID, rank),
    FOREIGN KEY (CID, AccName) REFERENCES Characters(ID, AccName) ON DELETE CASCADE
	FOREIGN KEY (location) REFERENCES Server(location) ON DELETE CASCADE ON UPDATE CASCADE
}
